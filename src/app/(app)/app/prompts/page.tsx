...
import { ScopeFilter, PlatformFilter } from '@/components/prompts/scope-filter';
...
export default function PromptsPage() {
  ...
  useEffect(() => {
    ...
    loadPrompts();
  }, [search, activeCategory, activeFramework, activeScope, activePlatform]);
